...
/**
 * CS2030 Lab 3: ShopSimulation.java
...
class ShopSimulation extends Simulation {
  ...
  public ShopSimulation(Scanner sc) {
    ...
    int maxCounterQLength = sc.nextInt();
    int maxShopQLength = sc.nextInt();
    this.shop = new Shop(numOfCounters, maxCounterQLength, maxShopQLength);
