...
public abstract class Maybe<T> {
   ...
   * 
   * @param condition The condition to filter the Maybe class.
   * @return A None instance if condition not fulfilled; else, returns the instance.
   */
   ...
   * 
   * @param transformer This determines how the Maybe instance will be transformed.
   * @param <S> The return type of the mapped Maybe instance.
   * @return The mapped Maybe instance
   */
  public abstract <S> Maybe<S> map(Transformer<? super T, ? extends S> transformer);

  /** This is an abstract flat map method. 
   * 
   * @param transformer Determines how the Maybe instance will be transformed.
   * @param <S> The return type of the flat mapped Maybe instance.
   * @return The flat mapped Maybe instance.
   */
   ...
   *
   * @param alternativeValue The value to be returned if this is an instance of None.
   * @return This instance if not None; otherwise alternative value will be returned.
   */
  public abstract T orElse(T alternativeValue);

  /** This is an abstract or else get method. i
   * 
   * @param producer The producer which will produce a value if this is an instance of None.
   * @param return The value produced by the producer if None.
   */
